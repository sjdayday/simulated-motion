    ...
    methods (Test)
        function testReporterCreatesDiaryAndStepCsvFiles(testCase)
            ...
            testCase.assertEqual(reporter.getHeader(), ...
                '"seed","step","placeId","simulated","turn/run","placeRecognized","retracedTrajectory","successfulRetrace","gridSquarePercent","saturationPercent","sparsePlaceId","ripples","grids","headDirectionCells","tag","pipeTag"'); 
