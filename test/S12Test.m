...
%             placeList = script.ec.animal.hippocampalFormation.placeListDisplay;
            testCase.assertEqual(script.ec.animal.hippocampalFormation.headDirectionSystem.nHeadDirectionCells, 12); 
            testCase.assertEqual(script.ec.animal.hippocampalFormation.lecSystem.nHeadDirectionCells, 12);         
            ...
            testCase.assertEqual(script.ec.environment.directionIntervals, 12);            
