...
%             obj.ec.randomHeadDirection = false; % no effect?  
            ...
            obj.ec.addAnimalEvent(12, 'obj.motorCortex.runDistance = 3; obj.motorCortex.run();');             % obj.ec.addAnimalEvent(12, 'obj.turn(-1,1);'); 
...
%             obj.ec.addControllerEvent(25, 'disp(''now in physical orientation where features are detectable; internal head direction should adjust.''); pause(10); ')
            obj.ec.addAnimalEvent(30, 'obj.showFeatures = 1; obj.features = [30 52]; obj.hippocampalFormation.headDirectionSystem.clockwiseVelocity = 0; obj.clockwiseVelocity = 0'); 
            ...
            obj.ec.addAnimalEvent(75, 'obj.motorCortex.runDistance = 8; obj.motorCortex.run();'); 
        end
