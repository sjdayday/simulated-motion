...
cr.addAnimalEvent(10, 'obj.orientAnimal(pi/4); obj.headDirectionSystem.clockwiseVelocity = -obj.minimumVelocity;'); 
...
cr.addAnimalEvent(11, 'obj.headDirectionSystem.clockwiseVelocity = -obj.minimumVelocity;'); 
...
cr.addAnimalEvent(15, 'obj.showFeatures = 1; obj.features = [30 52]; obj.headDirectionSystem.clockwiseVelocity = 0;'); 
